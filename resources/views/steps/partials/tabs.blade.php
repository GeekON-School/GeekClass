<div class="row">
    <div class="col">
        <ul class="nav nav-pills nav-fill @if (count($tasks)==0 || $one_tasker || $quizer) float-right @endif"
            ...
            <li class="nav-item">
                <a class="nav-link task-pill" data-toggle="pill" id="tasks-tab{{$task->id}}" href="#task{{$task->id}}"
            ...
            <li class="nav-item" style="max-width: 45px;">
                <button type="button" class="nav-link btn btn-success" data-toggle="modal" data-target="#exampleModal"

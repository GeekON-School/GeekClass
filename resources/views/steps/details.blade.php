                                                        ...
                                                        <div class="col-md-12">
                                                            @if (!$task->is_code)
                                                                <textarea id="text{{$task->id}}" class="form-control"
                                                                          name="text" style="margin-top: 15px;" rows="4">{{old('text')}}</textarea>

                                                                <small class="text-muted">Пожалуйста, не используйте это
                                                                    поле
                                                                    для
                                                                    отправки
                                                                    ...
                                                                    а
                                                                    затем
                                                                    скопируйте ссылку сюда.<br>Для загрузки картинок и
                                                                    небольших

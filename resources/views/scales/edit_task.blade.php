        ...
        <div class="col">
            <form method="POST" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" id="is_demo" name="is_demo" value="yes" @if ($task->is_demo) checked @endif/>
                </div>

                <div class="form-group">
                    <label for="is_training">Тренировочное задание</label>
                    <input type="checkbox" id="is_training" name="is_training" value="yes" @if ($task->is_training) checked @endif/>
                </div>

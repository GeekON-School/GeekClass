                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-group required">
                            ...
                            <input type="date" name="date" class="date form-control hasDatepicker" required="" id="dp1570721390164" value="{{\Carbon\Carbon::parse($event->date)->format("Y-m-d")}}">
                            @if ($errors->has('date'))
                                <span class="help-block error-block">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="max_people" class="form-control" value="{{$event->max_people}}">
